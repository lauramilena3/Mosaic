...
rule createContigBowtieDb:
	input:
		positive_contigs=dirs_dict["VIRAL_DIR"]+ "/" + REFERENCE_CONTIGS + ".{sampling}.fasta",
	output:
		contigs_bt2=dirs_dict["MAPPING_DIR"]+ "/" + REFERENCE_CONTIGS + ".{sampling}.1.bt2",
		contigs_info=dirs_dict["VIRAL_DIR"]+ "/" + REFERENCE_CONTIGS + ".{sampling}.fasta.fai",
		contigs_lenght=dirs_dict["VIRAL_DIR"]+ "/" + REFERENCE_CONTIGS + "_lenght.{sampling}.txt",
	params:
		prefix=dirs_dict["MAPPING_DIR"]+ "/" + REFERENCE_CONTIGS + ".{sampling}",
	message:
...
rule mapReadsToContigsPE:
	...
	params:
		contigs=dirs_dict["MAPPING_DIR"]+ "/" + REFERENCE_CONTIGS + ".{sampling}",
	message:
