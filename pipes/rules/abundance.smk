...
rule createContigBowtieDb:
	...
	output:
		...
		contigs_info=dirs_dict["VIRAL_DIR"]+ "/" + REFERENCE_CONTIGS_BASE + ".{sampling}.fasta.fai",
		contigs_lenght=dirs_dict["VIRAL_DIR"]+ "/" + REFERENCE_CONTIGS_BASE + "_lenght.{sampling}.txt",
	params:
		prefix=dirs_dict["MAPPING_DIR"]+ "/" + REFERENCE_CONTIGS_BASE + ".{sampling}",
	message:
