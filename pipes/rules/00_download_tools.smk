...
rule get_mmseqs:
	...
	shell:
		...
		{params.mmseqsdir}/build/bin/mmseqs createdb {output.refseq} RefSeqViral.fnaDB
		{params.mmseqsdir}/build/bin/mmseqs createtaxdb RefSeqViral.fnaDB tmp --ncbi-tax-dump {params.taxdump} --tax-mapping-file {output.refseq_taxid}
		"""
rule get_ALE:
	output:
